...
// const redisBullMqFullConfig = require('./config.');
...
class MyQueueSingleton {
  ...
  constructor() {
    ...
    this.myQueue = new Queue('emailSchedule', { connection: config.redis.redisBullMqFullConfig });
  }
...
const processJobs = () => {
  ...
  }, { connection: config.redis.redisBullMqFullConfig });
